...
Once the `conda-forge` channel has been enabled, `equinox` can be installed with:

```
conda install equinox
```

It is possible to list all of the versions of `equinox` available on your platform with:
